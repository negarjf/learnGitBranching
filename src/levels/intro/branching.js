exports.level = {
  ...
  "hint": {
    ...
    "fa": "با دستور \"git branch <branch-name>\"  یک برنچ جدید بسازید و با دستور \"git checkout <branch-name>\" به این برنچ بروید."
  },
  "disabledMap": {
    "git revert": true
  },
      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              "## برنچ در گیت",
              "",
              "برنچ‌ها در گیت فوق‌العاده سبک هستند. اونها اشاره‌گر‌ یک کامیت خاص هستند، نه بیشتر. بخاطر همین ورد زبان علاقه‌مندان به گیت اینه:",
              "",
              "```",
              "زود برنچ بسازید و زیاد.",
              "```",
              "",
              "از اونجایی که با ساختن برنچ زیاد جای زیادی را در حافظه اشغال نمی‌کنید، بهتره کار‌هاتون رو به صورت منطقی بین برنچ‌‌های مختلف تقسیم کنید؛ تا این که برنچ‌های بزرگ داشته باشید.",
              "",
              "به محض این که از برنچ‌‌‌‌‌‌‌‌‌‌ها و کامیت‌ها صحبت کنیم خواهید دید که این دو خصیصه با زیبایی با هم ترکیب می‌شن. اما فعلا فقط به خاطر بسپرید، اساسا چیزی که یک برنچ می‌گه اینه که «من تمام کار‌های این کامیت و کامیت‌های والدش رو در بر دارم.»"
            ]
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "بریم ببینیم برنچ‌ها در عمل چطور هستند.",
              "",
              "اینجا ما یک برنچ جدید به نام `newImage` می‌سازیم."
            ],
            "afterMarkdowns": [
              "بفرمایید! اینم تمام چیزی که از برنچ ساختن گفتیم. حالا برنج `newImage` به کامیت `C1` اشاره داره."
            ],
            "command": "git branch newImage",
            "beforeCommand": ""
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "بیاید روی این برنچ جدید کمی کار کنیم. روی دکمه زیر کلیک کنید."
            ],
            "afterMarkdowns": [
              "اوه نه! برنچ `master` حرکت کرد ولی برنچ `newImage` نه! این به خاطر اینه که ما `روی` برنچ جدید نبودیم. به همین دلیل ستاره(*) روی `master` بود."
            ],
            "command": "git commit",
            "beforeCommand": "git branch newImage"
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "بیاید به گیت بگیم که ما ‌می‌خوایم به برنچ جدید برویم.",
              "",
              "```",
              "git checkout <name>",
              "```",
              "",
              "با این کار ما قبل از کامیت کردن تغییرات به برنچ جدید می‌رویم."
            ],
            "afterMarkdowns": [
              "بفرمایید! حالا تغغراتمون روی برنچ جدید ثبت شد."
            ],
            "command": "git checkout newImage; git commit",
            "beforeCommand": "git branch newImage"
          }
        },
        {
          ...
          "options": {
            "markdowns": [
              "خب، الآن شما کاملا  آماده کار با برنچ‌ها هستید. به محض بسته شدن این پنجره،",
              "یک برنچ جدید به نام `bugFix` بسازید و به اون برنج بروید.",
              "",
              " راستی، یک میون‌بر هم داریم: اگر می‌خواید یخ برنچ جدید بسازید",
              "و هم زمان روی اون برنچ برید، می‌تونید به سادگی این دستور رو بنویسید.",
              "`git checkout -b [اسم برنچ جدید]`."
            ]
          }
        }
      ]
